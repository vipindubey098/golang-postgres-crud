    ...
    "paths": {
        "/department": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Department JSON payload",
                        "name": "department",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/department/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated fields object",
                        "name": "department",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/employeedetail": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "EmployeeDetail JSON payload",
                        "name": "employeedetail",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.EmployeeDetail"
                        }
                    }
                ],
                "responses": {
        ...
        "/employees": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Employee JSON payload",
                        "name": "employee",
                        "in": "body",
                        "required": true,
                        "schema": {
